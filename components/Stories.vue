  ...
  <div class="bg-white py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Articulos relacionados</h2>
...
const posts = [
  {
    ...
    imageUrl:
      'https://picsum.photos/seed/picsum23/384/256',
    date: 'Mar 16, 2020',
    datetime: '2020-03-16',
    category: { title: 'Turismo', href: '#' },
    author: {
      name: 'Autor',
      role: 'Experto',
      href: '#',
  ...
  {  id: 1,
    ...
    description:
      'Illo sint voluptas. Error voluptates culpa eligendi. Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde. Sed exercitationem placeat consectetur nulla deserunt vel. Iusto corrupti dicta.',
    imageUrl:
      'https://picsum.photos/seed/picsum1/384/256',
    date: 'Mar 16, 2020',
    datetime: '2020-03-16',
    category: { title: 'Turismo', href: '#' },
    author: {
  ...
  {  id: 1,
    ...
    description:
      'Illo sint voluptas. Error voluptates culpa eligendi. Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde. Sed exercitationem placeat consectetur nulla deserunt vel. Iusto corrupti dicta.',
    imageUrl:
      'https://picsum.photos/seed/picsum2/384/256',
    date: 'Mar 16, 2020',
    datetime: '2020-03-16',
    category: { title: 'Turismo', href: '#' },
    author: {
