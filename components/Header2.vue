<template>
 ...
 <!--        <Popover class="relative">
    ...
    <div class="relative isolate overflow-hidden pt-14">
      ...
      <!-- <picture>
  <source srcset="/header-mobile.png" media="(max-width: 768px)">
  <img src="/header-desktop.png" class="absolute inset-0 -z-10 h-full w-full object-scale-down sm:object-cover lg:object-cover object-top ">
</picture> -->
     <!--  <img src="/public/header-desktop.png" 
     srcset="/header-mobile.png 768w, /header-desktop.png 1024w" 
     sizes="(max-width: 768px) 100vw, 1024px" 
     class="absolute inset-0 -z-10 h-full w-full object-scale-down lg:object-cover object-top"> -->
      <!-- <img src="/header.png" alt="" class="absolute inset-0 -z-10 h-full w-full object-scale-down lg:object-cover object-top" /> -->
      <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
        <div class="" />
      </div>
      <div class="mx-auto max-w-7xl px-6 lg:px-8 ">
        
         <HomeSearch v-if="myProp == 0" />
      </div>
