      ...
      <div class="mx-auto w-full max-w-sm lg:w-96">
        <div>
          ...
          <p class="mt-2 text-sm leading-6 text-gray-500">
            ¿Aun no eres miembro?
            {{ ' ' }}
            <a href="/register" class="font-semibold text-indigo-600 hover:text-indigo-500">Registrate</a>
          </p>
        </div>
            ...
            <form action="#" method="POST" class="space-y-6">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  ...
                  <label for="remember-me" class="ml-3 block text-sm leading-6 text-gray-700">Recordar este dispositivo</label>
                </div>
              ...
              <div>
                <button type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Inicia sesión</button>
              </div>
            </form>
          </div>
          ...
          <div class="mt-10">
            <div class="relative">
              ...
              <div class="relative flex justify-center text-sm font-medium leading-6">
                <span class="bg-white px-6 text-gray-900">O inicia con:</span>
              </div>
            </div>
...
<g>
  ...
  <path style="fill:#FFFFFF;" d="M163.394,100.277h18.772v-27.73h-22.067v0.1c-26.738,0.947-32.218,15.977-32.701,31.763h-0.055
    ...
    <div class="relative hidden w-0 flex-1 lg:block">
      <img class="absolute inset-0 h-full w-full object-cover" src="/login.jpg" alt="" />
    </div>
  </div>
</template>
